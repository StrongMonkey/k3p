...
import (
	...
	helmk3siov1alpha1 "github.com/rancher/k3p/pkg/apis/helm.k3s.io/v1alpha1"
	versioned "github.com/rancher/k3p/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/rancher/k3p/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/rancher/k3p/pkg/generated/listers/helm.k3s.io/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.HelmV1alpha1().Charts(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HelmV1alpha1().Charts(namespace).Watch(options)
			},
		},
		&helmk3siov1alpha1.Chart{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *chartInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&helmk3siov1alpha1.Chart{}, f.defaultInformer)
}
