...
var chartsResource = schema.GroupVersionResource{Group: "helm.k3s.io", Version: "v1alpha1", Resource: "charts"}

var chartsKind = schema.GroupVersionKind{Group: "helm.k3s.io", Version: "v1alpha1", Kind: "Chart"}
